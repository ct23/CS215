...
public class MergeSort {
	 ...
	 */
	public void mergeSort(int[] origArray, int p, int r) {
	...
	/**
	 * Starts timer and runs merge sort
	 * @param origArray	Original array to be sorted
	 * @param p			First element in array
	 * @param r			Last element in arary
	 * @return duration	Time to sort, in nanoseconds
	 */
	public long mergeSortDriver(int[] origArray, int p, int r) {
		// Start duration clock
		long duration = System.nanoTime();

		// Run merge sort:
		mergeSort(origArray, p, r);
